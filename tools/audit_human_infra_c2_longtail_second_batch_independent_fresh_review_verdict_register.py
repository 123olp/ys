#!/usr/bin/env python3
"""审计 C2-LT-B2 独立 fresh review verdict 账本。"""
...
SCHEMA = "human-infra.c2-longtail-second-batch-independent-fresh-review-verdict-register.v1"
PARTIAL_STATUS = "active-fresh-review-verdict-register-partial"
COMPLETE_STATUS = "active-fresh-review-verdict-register-complete"
VERDICT_LINK = "human-infra-c2-longtail-second-batch-independent-fresh-review-verdict-register.json"
...
def validate_scope(verdict: dict[str, Any], batches: list[dict[str, Any]], errors: list[str]) -> tuple[list[dict[str, Any]], list[str]]:
    ...
    expected_counts = {
        ...
        "totalLocalReviewedExtractionTaskCount": 24,
        "reviewedExtractionTaskCount": len(reviewed_task_ids),
        "remainingExtractionTaskCount": 24 - len(reviewed_task_ids),
...
def main() -> int:
    ...
    load_json(LOCAL_REVIEW_PATH, errors, "C2-LT-B2 local review register")
    ...
    print(f"C2 longtail second-batch independent fresh review verdict audit ok: reviewed={reviewed} remaining={remaining}")
    return 0
