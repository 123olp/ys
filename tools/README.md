...
- `audit_human_infra_independent_fresh_review_verdict_register.py`: verifies that `docs/reference/human-infra-independent-fresh-review-verdict-register.json` records the first independent fresh-review verdict batch over 5 source anchors and 26 promotion packets, while preserving blocked uses, source-role boundaries and index links.
