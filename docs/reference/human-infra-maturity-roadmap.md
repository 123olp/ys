...
| 研究框架 | 70% | 每条主张都进入 Source Card、Claim-Evidence Matrix、变量表和反证条件 | 已有核心主张矩阵、页面级 Claim ID 门禁、arXiv-style 论文页强主张门禁、C1/20 个优先 C2 反证覆盖门禁、方法锚点和本地审计门禁，但 20 域之外的 C2 长尾域和 Source Cards 的主张级证据闭环还不均匀 |
