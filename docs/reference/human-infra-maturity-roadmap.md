...
- 把 `human-infra-domain-source-specific-extraction-register.json` 的 81 个 completed rows 推进到 fresh-reviewed Source Cards、变量卡、endpoint 卡、uncertainty 卡和 transfer-boundary 卡，并继续把 C1/C2 长尾域接入同一矩阵。
