...
- NHATS acquisition readiness validation 是否存在，是否回到当前机器契约 hash，是否 `PASS`，是否证明 1 个 official-source-refresh 门 ready、9 个 readiness gates 仍阻塞 extraction，并继续禁止下载、抽取、raw data 入库、校准和个体预测。
