...
- 按 `human-infra-c2-longtail-coverage-register.json` 把 184 个未覆盖 C2 长尾域分批推进到 Claim-Evidence row、source extraction、source-specific deep read、local source-context review、independent fresh review 和 reviewed artifacts。所有模型门禁完成前仍禁止模型准入。
