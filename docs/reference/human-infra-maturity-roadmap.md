...
- 按 `human-infra-domain-source-specific-extraction-queue.json` 的 81 个 domain-source 任务继续完成 exact claim / endpoint / population / effect-size / uncertainty / transfer-boundary Source Cards，并继续把 C1/C2 长尾域接入同一矩阵。
