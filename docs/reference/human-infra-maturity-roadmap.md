...
C2 长尾第六批晋升队列见 [`human-infra-c2-longtail-sixth-batch-promotion-queue.json`](human-infra-c2-longtail-sixth-batch-promotion-queue.json)，由 `make c2-longtail-sixth-batch-promotion-audit` 检查 12 个第六批跨代连续性、生殖力、孕产新生儿、儿童免疫、儿童铅暴露、儿童喂养吞咽、哺乳和儿童口腔健康 C2 长尾域是否已绑定 24 个 web-checked 候选来源、晋升步骤和模型阻塞边界。该队列只是 source-specific 深读入口，不完成 Source Card、fresh review、reviewed artifacts 或模型准入。
