...
- 按 `human-infra-independent-fresh-review-verdict-register.json` 从已完成 FRB-01 到 FRB-04 的 81 个 verdict 出发，先填 bounded reviewed Source Cards、变量卡、endpoint 卡、uncertainty 卡、transfer-boundary 卡和 downgrade checks。所有卡片完成和模型门禁完成前仍禁止模型准入。
