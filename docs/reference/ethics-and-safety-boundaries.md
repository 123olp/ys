...
- 系统边界建模。
- 脑-身接口协议、接口因果等价和最小充分身体的高层概念建模。
- 生命支持、控制器、传感器反馈和执行器的非操作性架构描述。
- 分析血流、氧气、营养、代谢废物、激素、免疫信号、内感受、感觉输入和运动指令等交换通道的变量、方向、频率、精度、允许误差和闭环效果。
...
- 把“器官功能相似”“设备形态相似”或“局部功效替代”写成脑-身接口等价、替代身体可行或个人生存收益。
