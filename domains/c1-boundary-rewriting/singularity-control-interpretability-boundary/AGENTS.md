# singularity-control-interpretability-boundary 目录说明
...
`singularity-control-interpretability-boundary/` 维护奇点控制与解释权边界研究域。它关注主体在超人 AI 或高加速技术系统中是否仍保有理解、否决、退出和治理能力。
...
- 所有风险主张必须区分能力风险、控制风险、解释风险、治理风险、分配风险和尾部风险。
- 不记录可操作攻击、绕过、扩散或失控步骤。
- 与 C3/C4 AI 治理域交叉时，本域只维护 C1 边界断裂问题；具体审计流程和工具文档留给下游域。
