# superhuman-intelligence-threshold 目录说明
...
`superhuman-intelligence-threshold/` 维护 Vinge 路线的超人智能阈值研究域。它只处理能力边界、证据边界和 Human Infra 变量，不把未来学预测写成事实结论。
...
- 每个能力主张必须说明任务范围、评估来源、对照基线、失败模式和不可外推范围。
- 不把单项 benchmark、产品演示或宣传材料直接升级为“通用超人智能”证据。
- 与 C3 AI 工具域交叉时，本域只保留会改写未来边界的 C1 问题；普通工具增强留在 C3。
