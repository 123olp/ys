# recursive-self-improvement-intelligence-explosion 目录说明
...
| 字段 | 内容 |
| --- | --- |
| 物理路径 | `domains/c1-boundary-rewriting/recursive-self-improvement-intelligence-explosion` |
| 所属层级 | `C1` - 可能性边界改写层 |
...
`recursive-self-improvement-intelligence-explosion/` 维护智能爆炸研究域。它关注 AI 参与改进 AI 的递归机制、必要条件、反证条件和治理中止门槛。
...
- 任何“递归增强”主张必须拆成 AI 研发能力、迭代周期、反馈质量、人类监督延迟和外部约束。
- 不把普通自动化、代码生成或模型规模增长直接升级为智能爆炸。
- 所有内容必须同时记录正向技术窗口压缩和负向控制风险放大。
