...
- `audit_life_path_toy_model.py`：审计 `web/src/data/life-path-toy-model.json`、`data/manual/life_path_calibration_readiness.json` 和 `data/manual/life_path_data_source_candidates.json`，并导出 `web/src/data/life-path-toy-model-audit.json` / `.md`。
