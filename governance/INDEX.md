...
- [OK] `context/AGENT-ENTRY.md`
- [OK] `context/CONTEXT-MAP.md`
- [OK] `context/CONTEXT-ROUTER.md`
- [OK] `context/PROJECT-TOPOLOGY.md`
...
- [REQUIRED-MISSING] `standards/架构设计原则.md`
- [optional] `standards/工程变更安全标准.md`

## 流程

- [OK] `processes/代理协作协议.md`
...
- [OK] `architecture-gates/门禁与护栏.md`
- [OK] `architecture-gates/GATE-INDEX.md`
